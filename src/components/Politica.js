...
function Politica() {
  ...
  return (
    <div className="politica">      
        <div className='titols'>Clàusula Informativa de normativa de Protecció de Dades (RGPD)</div>
        <div className='textgran'>
            <h3>Introducció</h3>
            <p>Tot seguit us informem de la política de privacitat de Xavier Gil Pasqual, d’acord amb la
            ...
            <p>La persona responsable de la protecció de dades és qui s’encarrega del compliment de la
                ...
                personals que hàgiu proporcionat a Xavier Gil Pasqual. Si teniu qualsevol dubte, consulta o
            ...
            <p>Xavier Gil Pasqual és responsable únicament de la informació que obté amb prèvia sol·licitud
            ...
            <p>L’objectiu de Xavier Gil Pasqual es que el client quedi satisfet en tots els serveis que li posem a
            ...
            <p>La base que empara els tractaments indicats és l’existència d’un interès legítim: es considera
                que, com a interessats en els serveis de Xavier Gil Pasqual, els usuaris donen el seu
            ...
            <ul>
                <li>
                    ...
                    aquells casos en què Xavier Gil Pasqual estigui obligada legalment a conservar-les.
                </li>
                <li>
                ...
                <li>
                Quan un usuari comuniqui a Xavier Gil Pasqual que vol deixar d’aparèixer en els seus
                fitxers, s’eliminaran totes les seves dades que no siguin estrictament necessàries per
                completar les gestions administratives i acadèmiques dels cursos de Xavier Gil Pasqual
                a què s’hagi inscrit.
                </li>
            </ul>
            <p>
                Totes les dades es desen en els servidors de Xavier Gil Pasqual o contractats per aquesta, en
                territori espanyol.
            </p>
            <p>
                ...
                possible contractació dels serveis que Xavier Gil Pasqual posi a disposició dels usuaris. Per tant,
                és obligatori acceptar i complir aquesta política de privacitat abans d’accedir als llocs web o
                contractar un servei de Xavier Gil Pasqual.
            </p>
            <p>
                L’usuari accepta que la navegació pels llocs web comporta la recollida i tractament de les seves
                dades en els fitxers de Xavier Gil Pasqual. Per tal que l’usuari sigui conscient de quina serà la
                informació recopilada, com serà tractada i en quines circumstàncies es comunicarà, Xavier Gil
                Pasqual es compromet a actualitzar en aquesta pàgina els canvis que s’efectuïn en la política
                de privacitat, així com a anunciar-los en qualsevol altre lloc que consideri apropiat.
            </p>
            <h3>Comunicació a tercers</h3>
            <p>
                Xavier Gil Pasqual no cedirà les dades personals de l’usuari a tercers, excepte per obligació
            ...
            <p>
                ...
                deroga la Directiva 95/46/CE (Reglament general de protecció de dades), Xavier Gil Pasqual es
            ...
            <p>
                ...
                seran aquests últims, i no Xavier Gil Pasqual, els responsables de les dades de caràcter
            ...
            <ul>
                ...
                <li>
                    ...
                    part de Xavier Gil Pasqual, sempre que hi hagi un motiu legítim i fonamentat per fer-
                    ho.
                </li>
            </ul>
            <p>
            ...
            <p>
                ...
                comerç electrònic (LSSI-CE), Xavier Gil Pasqual sol·licitarà a l’usuari el seu consentiment exprés
            ...
            <p>
                Dins cada comunicació comercial de Xavier Gil Pasqual es facilitarà a l’usuari un enllaç que li
            ...
            <p>
                ...
                Xavier Gil Pasqual ha adoptat els nivells de seguretat requerits per la normativa en protecció
